...
#include "instances/blocked_bloomfilter_logic_u32_instance.hpp" // extern templates to parallelize builds
...
void
bbf_32::batch_insert(bbf_32::word_t* __restrict filter_data, u32* keys, u32 key_cnt) {
