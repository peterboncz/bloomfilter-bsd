...
struct bloomfilter_addressing_logic {
  ...
  bloomfilter_addressing_logic(const size_t block_cnt, const size_t block_cnt_log2)
      : block_cnt(block_cnt), block_cnt_log2(block_cnt_log2) { }

  virtual ~bloomfilter_addressing_logic() = default;
...
struct bloomfilter_addressing_logic_magic : bloomfilter_addressing_logic {
 ...
 public:
  ...
  bloomfilter_addressing_logic_magic(const size_t desired_block_cnt) noexcept
      : bloomfilter_addressing_logic(determine_block_cnt(desired_block_cnt),
...
struct bloomfilter_addressing_logic_pow2 : bloomfilter_addressing_logic {
 ...
 public:
  ...
  bloomfilter_addressing_logic_pow2(const size_t desired_block_cnt) noexcept
      : bloomfilter_addressing_logic(determine_block_cnt(desired_block_cnt),dtl::log_2(determine_block_cnt(desired_block_cnt))),
